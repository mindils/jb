...
public class VacancyQueryDslFilterBuilder {
  ...
  public static Predicate build(AppVacancyFilterDto filter) {
    return QPredicate.builder()
        ...
        .add(filter.getSalaryFrom(), salaryFrom -> QVacancy.vacancy.salary.from.isNull()
            .or(QVacancy.vacancy.salary.from.gt(filter.getSalaryFrom())))
        .add(filter.getSalaryTo(), salaryTo -> QVacancy.vacancy.salary.to.isNull()
            .or(QVacancy.vacancy.salary.to.lt(salaryTo)))
