...
INSERT INTO employer (id, name, trusted, description, detailed, created_at)
VALUES
...
INSERT INTO vacancy (id, name, employer_id, premium, city, salary_gross, salary_from, salary_to, salary_currency, type, published_at, created_at, archived, apply_alternate_url, url, alternate_url, schedule, response_url, professional_roles, employment, description)
VALUES
...
INSERT INTO vacancy_info (vacancy_id, ai_approved, approved, status)
VALUES
